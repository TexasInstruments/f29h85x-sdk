...
all: 
	$(MAKE) -C $(CURDIR) -f makefile_uart_led_blinky all
	$(MAKE) -C $(CURDIR) -f makefile_uart_sbl all BANKMODE=$(BANKMODE) APP=$(APP)


clean:
	$(MAKE) -C $(CURDIR) -f makefile_uart_led_blinky clean
	$(MAKE) -C $(CURDIR) -f makefile_uart_sbl clean BANKMODE=$(BANKMODE) APP=$(APP)
