/*
 * R5RBL Certificate Module
 *
 * This is the R5 RBL certificate module which allows the parsing of the
 * X509 certificate to get the total length of the certificate. This is
 * isolated from the more comprehensive X509 parser.
 *
...
//some API's from external CSL
//#include <ti/csl/cslr.h>
//#include <ti/modules/log/log.h>
#include <cert.h>
