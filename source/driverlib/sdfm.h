...
typedef enum
{
	SDFM_SYNC_PWM1_SOCA		 = 0,	//!SFDM sync source is PWM1 SOCA
	SDFM_SYNC_PWM1_SOCB		 = 1,	//!SFDM sync source is PWM1 SOCB
	SDFM_SYNC_PWM17_SOCA	 = 2,	//!SFDM sync source is PWM17 SOCA
	SDFM_SYNC_PWM17_SOCB	 = 3,	//!SFDM sync source is PWM17 SOCB
	SDFM_SYNC_PWM2_SOCA		 = 4,	//!SFDM sync source is PWM2 SOCA
	SDFM_SYNC_PWM2_SOCB		 = 5,	//!SFDM sync source is PWM2 SOCB
	SDFM_SYNC_PWM18_SOCA	 = 6,	//!SFDM sync source is PWM18 SOCA
	SDFM_SYNC_PWM18_SOCB	 = 7,	//!SFDM sync source is PWM18 SOCB
	SDFM_SYNC_PWM3_SOCA		 = 8,	//!SFDM sync source is PWM3 SOCA
	SDFM_SYNC_PWM3_SOCB		 = 9,	//!SFDM sync source is PWM3 SOCB
	SDFM_SYNC_PWM4_SOCA		 = 12,	//!SFDM sync source is PWM4 SOCA
	SDFM_SYNC_PWM4_SOCB		 = 13,	//!SFDM sync source is PWM4 SOCB
	SDFM_SYNC_PWM5_SOCA		 = 16,	//!SFDM sync source is PWM5 SOCA
	SDFM_SYNC_PWM5_SOCB		 = 17,	//!SFDM sync source is PWM5 SOCB
	SDFM_SYNC_PWM6_SOCA		 = 20,	//!SFDM sync source is PWM6 SOCA
	SDFM_SYNC_PWM6_SOCB		 = 21,	//!SFDM sync source is PWM6 SOCB
	SDFM_SYNC_PWM7_SOCA		 = 24,	//!SFDM sync source is PWM7 SOCA
	SDFM_SYNC_PWM7_SOCB		 = 25,	//!SFDM sync source is PWM7 SOCB
	SDFM_SYNC_PWM8_SOCA		 = 28,	//!SFDM sync source is PWM8 SOCA
	SDFM_SYNC_PWM8_SOCB		 = 29,	//!SFDM sync source is PWM8 SOCB
	SDFM_SYNC_PWM9_SOCA		 = 32,	//!SFDM sync source is PWM9 SOCA
	SDFM_SYNC_PWM9_SOCB		 = 33,	//!SFDM sync source is PWM9 SOCB
	SDFM_SYNC_PWM10_SOCA	 = 36,	//!SFDM sync source is PWM10 SOCA
	SDFM_SYNC_PWM10_SOCB	 = 37,	//!SFDM sync source is PWM10 SOCB
	SDFM_SYNC_PWM11_SOCA	 = 40,	//!SFDM sync source is PWM11 SOCA
	SDFM_SYNC_PWM11_SOCB	 = 41,	//!SFDM sync source is PWM11 SOCB
	SDFM_SYNC_PWM12_SOCA	 = 44,	//!SFDM sync source is PWM12 SOCA
	SDFM_SYNC_PWM12_SOCB	 = 45,	//!SFDM sync source is PWM12 SOCB
	SDFM_SYNC_PWM13_SOCA	 = 48,	//!SFDM sync source is PWM13 SOCA
	SDFM_SYNC_PWM13_SOCB	 = 49,	//!SFDM sync source is PWM13 SOCB
	SDFM_SYNC_PWM14_SOCA	 = 52,	//!SFDM sync source is PWM14 SOCA
	SDFM_SYNC_PWM14_SOCB	 = 53,	//!SFDM sync source is PWM14 SOCB
	SDFM_SYNC_PWM15_SOCA	 = 56,	//!SFDM sync source is PWM15 SOCA
	SDFM_SYNC_PWM15_SOCB	 = 57,	//!SFDM sync source is PWM15 SOCB
	SDFM_SYNC_PWM16_SOCA	 = 60,	//!SFDM sync source is PWM16 SOCA
	SDFM_SYNC_PWM16_SOCB	 = 61	//!SFDM sync source is PWM16 SOCB
} SDFM_PWMSyncSource;
...
{
    return(
           ((base & BASE_ADDR_MASK) == SDFM1_BASE_FRAME(0U)) ||
           ((base & BASE_ADDR_MASK) == SDFM2_BASE_FRAME(0U)) ||
           ((base & BASE_ADDR_MASK) == SDFM3_BASE_FRAME(0U)) ||
           ((base & BASE_ADDR_MASK) == SDFM4_BASE_FRAME(0U))
          );
}
#endif
