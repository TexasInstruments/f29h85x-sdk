...
//
#define ECAT_SS_ESCSS_IPREV_MASK (ECAT_SS_ESCSS_IPREVNUM_IP_REV_MINOR_S |\
                                  ECAT_SS_ESCSS_IPREVNUM_IP_REV_MINOR_M)

//
// Define for Mask Value to get the Raw Interrupt Mask.
//
#define ECAT_SS_ESCSS_RAW_INTERRUPT_MASK (ECAT_SS_ESCSS_INTR_RIS_SYNC0_RIS |\
                                          ECAT_SS_ESCSS_INTR_RIS_SYNC1_RIS |\
                                          ECAT_SS_ESCSS_INTR_RIS_IRQ_RIS |\
                                          ECAT_SS_ESCSS_INTR_RIS_DMA_DONE_RIS |\
                                          ECAT_SS_ESCSS_INTR_RIS_TIMEOUT_ERR_RIS |\
                                          ECAT_SS_ESCSS_INTR_RIS_MASTER_RESET_RIS)

//
// Define for Mask Value to get the Masked Interrupt Status.
//
#define ECAT_SS_ESCSS_INTERRUPT_MASK (ECAT_SS_ESCSS_INTR_MASK_SYNC0_MASK |\
                                      ECAT_SS_ESCSS_INTR_MASK_SYNC1_MASK |\
                                      ECAT_SS_ESCSS_INTR_MASK_IRQ_MASK |\
                                      ECAT_SS_ESCSS_INTR_MASK_DMA_DONE_MASK |\
                                      ECAT_SS_ESCSS_INTR_MASK_TIMEOUT_ERR_MASK |\
                                      ECAT_SS_ESCSS_INTR_MASK_MASTER_RESET_MASK)

//
// Define for Mask Value to Reset the Masked Interrupt Status.
//
#define ECAT_SS_ESCSS_RESET_INTERRUPT_MASK (ECAT_SS_ESCSS_INTR_MASK_SYNC0_MASK |\
                                            ECAT_SS_ESCSS_INTR_MASK_SYNC1_MASK |\
                                            ECAT_SS_ESCSS_INTR_MASK_IRQ_MASK |\
                                            ECAT_SS_ESCSS_INTR_MASK_DMA_DONE_MASK |\
                                            ECAT_SS_ESCSS_INTR_MASK_TIMEOUT_ERR_MASK |\
...
// Define for Mask Value to Get the Masked Interrupt Status.
//
#define ECAT_SS_ESCSS_GET_INTERRUPT_MASK (ECAT_SS_ESCSS_INTR_MIS_SYNC0_MIS |\
                                          ECAT_SS_ESCSS_INTR_MIS_SYNC1_MIS |\
                                          ECAT_SS_ESCSS_INTR_MIS_IRQ_MIS |\
                                          ECAT_SS_ESCSS_INTR_MIS_DMA_DONE_MIS |\
                                          ECAT_SS_ESCSS_INTR_MIS_TIMEOUT_ERR_MIS |\
                                          ECAT_SS_ESCSS_INTR_MIS_MASTER_RESET_MIS)

//
// Define for Mask Value to Clear the Masked Interrupt Status.
//
#define ECAT_SS_ESCSS_CLEAR_INTERRUPT_MASK (ECAT_SS_ESCSS_INTR_CLR_SYNC0_CLR |\
                                            ECAT_SS_ESCSS_INTR_CLR_SYNC1_CLR |\
                                            ECAT_SS_ESCSS_INTR_CLR_IRQ_CLR |\
                                            ECAT_SS_ESCSS_INTR_CLR_DMA_DONE_CLR |\
                                            ECAT_SS_ESCSS_INTR_CLR_TIMEOUT_ERR_CLR |\
                                            ECAT_SS_ESCSS_INTR_CLR_MASTER_RESET_CLR)

//
// Define for Mask Value to Set the Masked Interrupt Status.
//
#define ECAT_SS_ESCSS_SET_INTERRUPT_MASK (ECAT_SS_ESCSS_INTR_SET_SYNC0_SET |\
                                          ECAT_SS_ESCSS_INTR_SET_SYNC1_SET |\
                                          ECAT_SS_ESCSS_INTR_SET_IRQ_SET |\
                                          ECAT_SS_ESCSS_INTR_SET_DMA_DONE_SET |\
                                          ECAT_SS_ESCSS_INTR_SET_TIMEOUT_ERR_SET |\
                                          ECAT_SS_ESCSS_INTR_SET_MASTER_RESET_SET)

//
// Defines for the Group Capture Select Mask.
//
#define ECAT_SS_ESCSS_GRP_CAP_SELECT0_MASK ECAT_SS_ESCSS_GPIN_GRP_CAP_SEL_GPI_GRP_CAP_SEL0_M
#define ECAT_SS_ESCSS_GRP_CAP_SELECT1_MASK ECAT_SS_ESCSS_GPIN_GRP_CAP_SEL_GPI_GRP_CAP_SEL1_M
#define ECAT_SS_ESCSS_GRP_CAP_SELECT2_MASK ECAT_SS_ESCSS_GPIN_GRP_CAP_SEL_GPI_GRP_CAP_SEL2_M
#define ECAT_SS_ESCSS_GRP_CAP_SELECT3_MASK ECAT_SS_ESCSS_GPIN_GRP_CAP_SEL_GPI_GRP_CAP_SEL3_M
...
typedef enum
{
    ESCSS_GROUP_CAPTURE_SELECT0 = ECAT_SS_ESCSS_GPIN_GRP_CAP_SEL_GPI_GRP_CAP_SEL0_S,
    ESCSS_GROUP_CAPTURE_SELECT1 = ECAT_SS_ESCSS_GPIN_GRP_CAP_SEL_GPI_GRP_CAP_SEL1_S,
    ESCSS_GROUP_CAPTURE_SELECT2 = ECAT_SS_ESCSS_GPIN_GRP_CAP_SEL_GPI_GRP_CAP_SEL2_S,
    ESCSS_GROUP_CAPTURE_SELECT3 = ECAT_SS_ESCSS_GPIN_GRP_CAP_SEL_GPI_GRP_CAP_SEL3_S
...
ESCSS_readIPMinorRevNumber(uint32_t base)
{
    ...
    //
    return(((HWREG(base + ECAT_SS_O_ESCSS_IPREVNUM)) &
            ECAT_SS_ESCSS_IPREVNUM_IP_REV_MINOR_M) >>
            ECAT_SS_ESCSS_IPREVNUM_IP_REV_MINOR_S);
}
...
ESCSS_readIPMajorRevNumber(uint32_t base)
{
    ...
    //
    return(((HWREG(base + ECAT_SS_O_ESCSS_IPREVNUM)) &
            ECAT_SS_ESCSS_IPREVNUM_IP_REV_MAJOR_M) >>
            ECAT_SS_ESCSS_IPREVNUM_IP_REV_MAJOR_S);
}
...
ESCSS_readIPRevNumber(uint32_t base)
{
    ...
    //
    return((HWREG(base + ECAT_SS_O_ESCSS_IPREVNUM)) & ECAT_SS_ESCSS_IPREV_MASK);
}
...
ESCSS_getRawInterruptStatus(uint32_t base, uint16_t interruptMask)
{
    ...
    //
    ASSERT(ESCSS_isBaseValid(base));
    ASSERT((interruptMask & ~(ECAT_SS_ESCSS_RAW_INTERRUPT_MASK)) == 0U);

    //
    // Return the specific Raw Interrupt Status Value.
    //
    return((HWREG(base + ECAT_SS_O_ESCSS_INTR_RIS)) & interruptMask);
}
...
//!  \b ECAT_SS_ESCSS_INTR_RIS_SYNC0_RIS, \b ECAT_SS_ESCSS_INTR_RIS_SYNC1_RIS,
//!  \b ECAT_SS_ESCSS_INTR_RIS_IRQ_RIS, \b ECAT_SS_ESCSS_INTR_RIS_DMA_DONE_RIS,
//!  \b ECAT_SS_ESCSS_INTR_RIS_TIMEOUT_ERR_RIS, \b ECAT_SS_ESCSS_INTR_RIS_MASTER_RESET_RIS.
//!
//! \return Returns the Raw Interrupt Status Value.
//
//*****************************************************************************
...
ESCSS_readRawInterruptStatus(uint32_t base)
{
    ...
    //
    return(HWREG(base + ECAT_SS_O_ESCSS_INTR_RIS) & ECAT_SS_ESCSS_RAW_INTERRUPT_MASK);
}
...
//! \e interruptMask can be OR'ed together:
//! - \b ECAT_SS_ESCSS_INTR_MASK_SYNC0_MASK - Masks SYNC0 to have effect on interrupts
//!      or other CPU/DMA Trigger,
//! - \b ECAT_SS_ESCSS_INTR_MASK_SYNC1_MASK - Masks SYNC1 to have effect on interrupts
//!      or other CPU/DMA Trigger,
//! - \b ECAT_SS_ESCSS_INTR_MASK_IRQ_MASK - Masks EtherCATSS IRQ to have effect on
//!      interrupts or other CPU/DMA Trigger,
//! - \b ECAT_SS_ESCSS_INTR_MASK_DMA_DONE_MASK - Masks DMA Done to have effect on
//!      interrupts or other CPU/DMA Trigger,
//! - \b ECAT_SS_ESCSS_INTR_MASK_TIMEOUT_ERR_MASK - Masks PDI access timeout Error to
//!      have effect on interrupts or other CPU/DMA Trigger,
//! - \b ECAT_SS_ESCSS_INTR_MASK_MASTER_RESET_MASK - Masks EtherCAT Master reset event
...
ESCSS_setMaskedInterruptStatus(uint32_t base, uint16_t interruptMask)
{
    ...
    //
    ASSERT(ESCSS_isBaseValid(base));
    ASSERT((interruptMask & ~(ECAT_SS_ESCSS_INTERRUPT_MASK)) == 0U);
    //
    // Set the Masked Interrupt Status Value.
    //
    HWREGH(base + ECAT_SS_O_ESCSS_INTR_MASK) |= interruptMask;
}
...
ESCSS_resetMaskedInterruptStatus(uint32_t base, uint16_t interruptMask)
{
    ...
    //
    ASSERT(ESCSS_isBaseValid(base));
    ASSERT((interruptMask & ~(ECAT_SS_ESCSS_RESET_INTERRUPT_MASK)) == 0U);
    //
...
//! The Masked interrupt Status can have the following valid options for
//! \e interruptMask can be OR'ed together:
//!  \b ECAT_SS_ESCSS_INTR_MIS_SYNC0_MIS, \b ECAT_SS_ESCSS_INTR_MIS_SYNC1_MIS,
//!  \b ECAT_SS_ESCSS_INTR_MIS_IRQ_MIS, \b ECAT_SS_ESCSS_INTR_MIS_DMA_DONE_MIS,
//!  \b ECAT_SS_ESCSS_INTR_MIS_TIMEOUT_ERR_MIS, \b ECAT_SS_ESCSS_INTR_MIS_MASTER_RESET_MIS.
//!
...
ESCSS_getMaskedInterruptStatus(uint32_t base, uint16_t interruptMask)
{
    ...
    //
    ASSERT(ESCSS_isBaseValid(base));
    ASSERT((interruptMask & ~(ECAT_SS_ESCSS_GET_INTERRUPT_MASK)) == 0U);

    //
    // Return the Masked Interrupt Status Value.
    //
    return((HWREGH(base + ECAT_SS_O_ESCSS_INTR_MIS)) & interruptMask);
}
...
//!  \b ECAT_SS_ESCSS_INTR_CLR_SYNC0_CLR, \b ECAT_SS_ESCSS_INTR_CLR_SYNC1_CLR,
//!  \b ECAT_SS_ESCSS_INTR_CLR_IRQ_CLR, \b ECAT_SS_ESCSS_INTR_CLR_DMA_DONE_CLR,
//!  \b ECAT_SS_ESCSS_INTR_CLR_TIMEOUT_ERR_CLR, \b ECAT_SS_ESCSS_INTR_CLR_MASTER_RESET_CLR.
//!
//! \return None.
//
//*****************************************************************************
...
ESCSS_clearRawInterruptStatus(uint32_t base, uint16_t interruptMask)
{
    ...
    //
    ASSERT(ESCSS_isBaseValid(base));
    ASSERT((interruptMask & ~(ECAT_SS_ESCSS_CLEAR_INTERRUPT_MASK)) == 0U);
    //
    // Clear the Interrupt Status using the Mask Value passed.
    //
    HWREGH(base + ECAT_SS_O_ESCSS_INTR_CLR) = interruptMask;
}
...
ESCSS_selectLatch0Mux(uint32_t base, ESCSS_LatchTrigger muxSelectValue)
{
    ...
    //
    HWREGH(base + ECAT_SS_O_ESCSS_LATCH_SEL) |=
    (((uint32_t)muxSelectValue << ECAT_SS_ESCSS_LATCH_SEL_LATCH0_SELECT_S) &
     ECAT_SS_ESCSS_LATCH_SEL_LATCH0_SELECT_M);
}
...
ESCSS_selectLatch1Mux(uint32_t base, ESCSS_LatchTrigger muxSelectValue)
{
    ...
    //
    HWREGH(base + ECAT_SS_O_ESCSS_LATCH_SEL) |=
    (((uint32_t)muxSelectValue << ECAT_SS_ESCSS_LATCH_SEL_LATCH1_SELECT_S) &
     ECAT_SS_ESCSS_LATCH_SEL_LATCH1_SELECT_M);
}
...
ESCSS_configure16BitAsyncAccessWaitState(uint32_t base, uint16_t waitState)
{
    ...
    //
    HWREGH(base + ECAT_SS_O_ESCSS_ACCESS_CTRL) |=
    ((waitState << ECAT_SS_ESCSS_ACCESS_CTRL_WAIT_STATES_S) &
     ECAT_SS_ESCSS_ACCESS_CTRL_WAIT_STATES_M);
}
...
ESCSS_enablePDIAccessTimeOut(uint32_t base)
{
    ...
    // Enable timeout.
    //
    HWREGH(base + ECAT_SS_O_ESCSS_ACCESS_CTRL) |= ECAT_SS_ESCSS_ACCESS_CTRL_EN_TIMEOUT;
}
...
ESCSS_enableDebugAccess(uint32_t base)
{
    ...
    //
    HWREGH(base + ECAT_SS_O_ESCSS_ACCESS_CTRL) |=
    ECAT_SS_ESCSS_ACCESS_CTRL_ENABLE_DEBUG_ACCESS;
}
...
ESCSS_readGPINData(uint32_t base)
{
    ...
    //
    return(HWREG(base + ECAT_SS_O_ESCSS_GPIN_DAT));
}
...
ESCSS_setGPINData(uint32_t base, uint32_t pinValue)
{
    ...
    //
    HWREG(base + ECAT_SS_O_ESCSS_GPIN_DAT) |= pinValue;
}
...
ESCSS_enableGPIPipelinedRegCaptureOnEvent(uint32_t base, uint32_t pipelineMask)
{
    ...
    //
    HWREG(base + ECAT_SS_O_ESCSS_GPIN_PIPE) |= pipelineMask;
}
...
ESCSS_readGPOUTData(uint32_t base)
{
    ...
    //
    return(HWREG(base + ECAT_SS_O_ESCSS_GPOUT_DAT));
}
                                            ...
                                            uint32_t pipelineMask)
{
    ...
    //
    HWREG(base + ECAT_SS_O_ESCSS_GPOUT_PIPE) |= pipelineMask;
}
...
ESCSS_initMemory(uint32_t base)
{
    ...
    //
    HWREGH(base + ECAT_SS_O_ESCSS_MEM_TEST) |= ECAT_SS_ESCSS_MEM_TEST_INITIATE_MEM_INIT;
}
...
ESCSS_getMemoryInitDoneStatusNonBlocking(uint32_t base)
{
    ...
    //
    if((HWREG(base + ECAT_SS_O_ESCSS_MEM_TEST) & ECAT_SS_ESCSS_MEM_TEST_MEM_INIT_DONE) ==
       ECAT_SS_ESCSS_MEM_TEST_MEM_INIT_DONE)
...
ESCSS_isConfigurationLockEnabled(uint32_t base)
{
    ...
    //
    if((HWREG(base + ECAT_SS_O_ESCSS_CONFIG_LOCK) & ECAT_SS_ESCSS_CONFIG_LOCK_LOCK_ENABLE) ==
       ECAT_SS_ESCSS_CONFIG_LOCK_LOCK_ENABLE)
    {
...
//! - \b ECAT_SS_ESCSS_LED_CONFIG_LINKACT0 - GPIO enable for LINKACT0 LED,
//! - \b ECAT_SS_ESCSS_LED_CONFIG_LINKACT1 - GPIO enable for LINKACT1 LED,
//! - \b ECAT_SS_ESCSS_LED_CONFIG_STATE - GPIO enable for STATE LED,
//! - \b ECAT_SS_ESCSS_LED_CONFIG_ERR - GPIO enable for ERR LED,
//! - \b ECAT_SS_ESCSS_LED_CONFIG_RUN - GPIO enable for RUN LED.
//!
...
ESCSS_enableLEDOptions(uint32_t base, uint16_t ledSelectConfig)
{
    ...
    //
    ASSERT(ESCSS_isConfigBaseValid(base));
    ASSERT((ledSelectConfig & ~(ECAT_SS_ESCSS_LED_CONFIG_LINKACT0 |
                                ECAT_SS_ESCSS_LED_CONFIG_LINKACT1 |
                                ECAT_SS_ESCSS_LED_CONFIG_STATE |
                                ECAT_SS_ESCSS_LED_CONFIG_ERR |
                                ECAT_SS_ESCSS_LED_CONFIG_RUN)) == 0U);
    ...
    if((bool)true != ESCSS_isConfigurationLockEnabled(ESC_SS_CONFIG_BASE))
    {
        ...
        // Set the LED Options.
        //
        HWREGH(base + ECAT_SS_O_ESCSS_LED_CONFIG) |= ledSelectConfig;
        apiStatus = ESCSS_API_SUCCESS;
    }
    else
    {
...
//! The LED Configuration Mask parameter can have the following valid options
//! for \e ledSelectConfig can be OR'ed together:
//! - \b ECAT_SS_ESCSS_LED_CONFIG_LINKACT0,
//! - \b ECAT_SS_ESCSS_LED_CONFIG_LINKACT1,
//! - \b ECAT_SS_ESCSS_LED_CONFIG_STATE,
//! - \b ECAT_SS_ESCSS_LED_CONFIG_ERR,
//! - \b ECAT_SS_ESCSS_LED_CONFIG_RUN.
//!
//! \return Returns \b ESCSS_API_SUCCESS if the Register Access is successful,
//! \b ESCSS_API_FAIL if access to the Register Fails.
//
...
ESCSS_enableGPIN(uint32_t base, uint32_t selectValue)
{
    ...
    if((bool)true != ESCSS_isConfigurationLockEnabled(ESC_SS_CONFIG_BASE))
    {
        ...
        //
        HWREG(base + ECAT_SS_O_ESCSS_GPIN_SEL) |= selectValue;
        apiStatus = ESCSS_API_SUCCESS;
    }
    else
    {
...
ESCSS_enableGPOUT(uint32_t base, uint32_t selectValue)
{
    ...
    if((bool)true != ESCSS_isConfigurationLockEnabled(ESC_SS_CONFIG_BASE))
    {
        ...
        //
        HWREG(base + ECAT_SS_O_ESCSS_GPOUT_SEL) |= selectValue;
        apiStatus = ESCSS_API_SUCCESS;
    }
    else
    {
...
ESCSS_configureTX0ShiftForTxEnaAndTxData(uint32_t base, uint32_t shiftValue)
{
    ...
    if((bool)true != ESCSS_isConfigurationLockEnabled(ESC_SS_CONFIG_BASE))
    {
        ...
        ((uint16_t)((uint32_t)shiftValue <<
         ECAT_SS_ESCSS_MISC_CONFIG_TX0_SHIFT_CONFIG_S)
         & ECAT_SS_ESCSS_MISC_CONFIG_TX0_SHIFT_CONFIG_M);
...
ESCSS_configureTX1ShiftForTxEnaAndTxData(uint32_t base, uint32_t shiftValue)
{
    ...
    if((bool)true != ESCSS_isConfigurationLockEnabled(ESC_SS_CONFIG_BASE))
    {
        ...
        //
        HWREGH(base + ECAT_SS_O_ESCSS_MISC_CONFIG) |=
        ((shiftValue << ECAT_SS_ESCSS_MISC_CONFIG_TX1_SHIFT_CONFIG_S) &
         ECAT_SS_ESCSS_MISC_CONFIG_TX1_SHIFT_CONFIG_M);
...
ESCSS_enablePDIEmulation(uint32_t base)
{
    ...
    if((bool)true != ESCSS_isConfigurationLockEnabled(ESC_SS_CONFIG_BASE))
    {
        ...
        //
        HWREGH(base + ECAT_SS_O_ESCSS_MISC_CONFIG) |= ECAT_SS_ESCSS_MISC_CONFIG_PDI_EMULATION;
        apiStatus = ESCSS_API_SUCCESS;
    }
    else
    {
...
ESCSS_configurePhyAddressOffset(uint32_t base, uint16_t registerOffset)
{
    ...
    if((bool)true != ESCSS_isConfigurationLockEnabled(ESC_SS_CONFIG_BASE))
    {
        ...
        //
        HWREGH(base + ECAT_SS_O_ESCSS_MISC_CONFIG) |=
        ((uint16_t)((uint32_t)registerOffset << ECAT_SS_ESCSS_MISC_CONFIG_PHY_ADDR_S)
         & ECAT_SS_ESCSS_MISC_CONFIG_PHY_ADDR_M);
        apiStatus = ESCSS_API_SUCCESS;
    }
    else
    {
...
//! The interrupt Status Mask parameter can have the following valid options
//! for \e interruptMask can be OR'ed together:
//!  \b ECAT_SS_ESCSS_INTR_SET_SYNC0_SET, \b ECAT_SS_ESCSS_INTR_SET_SYNC1_SET,
//!  \b ECAT_SS_ESCSS_INTR_SET_IRQ_SET, \b ECAT_SS_ESCSS_INTR_SET_DMA_DONE_SET,
//!  \b ECAT_SS_ESCSS_INTR_SET_TIMEOUT_ERR_SET, \b ECAT_SS_ESCSS_INTR_SET_MASTER_RESET_SET.
//!
//! \return Returns \b ESCSS_API_SUCCESS  if the Register Access is successful,
//! \b ESCSS_API_FAIL if access to the Register Fails.
//
...
//! - \b ECAT_SS_ESCSS_SYNC0_CONFIG_CPUX_INT_EN - Connects the SYNC0 to CPUx
//!                                               Interrupt
//! - \b ECAT_SS_ESCSS_SYNC0_CONFIG_DMAX_TRIG_EN  - Connects the SYNC0 to DMA
//!                                                 Trigger
//!
//! \return Returns \b ESCSS_API_SUCCESS if the Register Access is successful,
//! \b ESCSS_API_FAIL if access to the Register Fails.
...
//! respective selection made. The following valid options for
//! \e connectionInterrupt are:
//! - \b ECAT_SS_ESCSS_SYNC1_CONFIG_CPUX_INT_EN - Connects the SYNC0 to CPUx
//!                                               Interrupt
//! - \b ECAT_SS_ESCSS_SYNC1_CONFIG_DMAX_TRIG_EN  - Connects the SYNC0 to DMA
//!                                                 Trigger
//!
//! \return Returns \b ESCSS_API_SUCCESS if the Register Access is successful,
//! \b ESCSS_API_FAIL if access to the Register Fails.
