...
for (var dbOutputIndex in device_driverlib_peripheral.EPWM_DeadBandOutput)
{
    ...
    var dbOutput_Configs = [
		...
		},
        {
            ...
            hidden      : true,
            default     : device_driverlib_peripheral.EPWM_MINDB_REF_SIG[0].name ,
            options     : device_driverlib_peripheral.EPWM_MINDB_REF_SIG
        },
        {
...
for (var dbOutputIndex in device_driverlib_peripheral.EPWM_DeadBandOutput)
{
    ...
    var dbOutput_Configs = [
        ...
        },
        {
            ...
            hidden      : true,
            default     : device_driverlib_peripheral.EPWM_MINDB_ICL_XBAR_OUT[0].name ,
    ...
    for (var ilcOutputIndex in device_driverlib_peripheral.EPWM_MINDB_ICL_LUT_DEC)
    {
        var ilcOutput = device_driverlib_peripheral.EPWM_MINDB_ICL_LUT_DEC[ilcOutputIndex];
