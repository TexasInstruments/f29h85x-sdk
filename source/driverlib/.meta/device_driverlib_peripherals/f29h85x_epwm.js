...
let EPWM_SyncInPulseSource = [
	...
	{ name: "EPWM_SYNC_IN_PULSE_SRC_SYNCOUT_EPWM17", displayName: "Sync-in source is EPWM15 sync-out signal" },
	{ name: "EPWM_SYNC_IN_PULSE_SRC_SYNCOUT_EPWM18", displayName: "Sync-in source is EPWM16 sync-out signal" },
...
let EPWM_DigitalCompareEdgeFilterMode = [
	{ name: "EPWM_DC_EDGEFILT_MODE_RISING", displayName: "Digital Compare Edge filter low to high edge mode" },
	{ name: "EPWM_DC_EDGEFILT_MODE_FALLING", displayName: "Digital Compare Edge filter high to low edge mode" },
	{ name: "EPWM_DC_EDGEFILT_MODE_BOTH", displayName: "Digital Compare Edge filter both edges mode" },
]
let EPWM_DigitalCompareEdgeFilterEdgeCount = [
	{ name: "EPWM_DC_EDGEFILT_EDGECNT_0", displayName: "Digital Compare Edge filter edge count = 0" },
	{ name: "EPWM_DC_EDGEFILT_EDGECNT_1", displayName: "Digital Compare Edge filter edge count = 1" },
	{ name: "EPWM_DC_EDGEFILT_EDGECNT_2", displayName: "Digital Compare Edge filter edge count = 2" },
	{ name: "EPWM_DC_EDGEFILT_EDGECNT_3", displayName: "Digital Compare Edge filter edge count = 3" },
	{ name: "EPWM_DC_EDGEFILT_EDGECNT_4", displayName: "Digital Compare Edge filter edge count = 4" },
	{ name: "EPWM_DC_EDGEFILT_EDGECNT_5", displayName: "Digital Compare Edge filter edge count = 5" },
	{ name: "EPWM_DC_EDGEFILT_EDGECNT_6", displayName: "Digital Compare Edge filter edge count = 6" },
	{ name: "EPWM_DC_EDGEFILT_EDGECNT_7", displayName: "Digital Compare Edge filter edge count = 7" },
]
...
let EPWM_SYNC_OUT_SOURCE_M = [
	{ name: "EPWM_SYNC_OUT_SOURCE_M", displayName: "M" },
]
...
let EPWM_DC_COMBINATIONAL_TRIPIN = [
...
module.exports = {
	...
	EPWM_MINDB_REF_SIG: EPWM_MINDB_REF_SIG,
	EPWM_MINDB_POLSEL: EPWM_MINDB_POLSEL,
	EPWM_MINDB_BLOCKING_SIGNAL: EPWM_MINDB_BLOCKING_SIGNAL,
	EPWM_MINDB_SEL: EPWM_MINDB_SEL,
	EPWM_MINDB_ICL_XBAR_OUT: EPWM_MINDB_ICL_XBAR_OUT,
	EPWM_MINDB_ICL_LUT_DEC: EPWM_MINDB_ICL_LUT_DEC,
	EPWM_DE_SRC_TRIP: EPWM_DE_SRC_TRIP,
	...
	EPWM_DC_COMBINATIONAL_TRIPIN: EPWM_DC_COMBINATIONAL_TRIPIN,
