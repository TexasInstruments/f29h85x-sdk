let CPUTimer_EmulationMode = [
	{ name: "CPUTIMER_EMULATIONMODE_STOPAFTERNEXTDECREMENT", displayName: "Timer Stop after the next decrement" },
	{ name: "CPUTIMER_EMULATIONMODE_STOPATZERO", displayName: "Timer stop when it reaches zero" },
	{ name: "CPUTIMER_EMULATIONMODE_RUNFREE", displayName: "Timer run free" },
]
