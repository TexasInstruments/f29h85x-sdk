...
var rtdma2Module = {
    ...
    config: Common.filterConfigsIfInSetupMode(rtdma_shared.getRTDMAConfig("RTDMA2")),
    ...
    moduleStatic: {
        ...
        config: Common.filterConfigsIfInSetupMode(rtdma_shared.getRTDMAGlobalConfig("RTDMA2")),
