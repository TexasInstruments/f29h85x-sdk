...
const bootPeriphMap = {
    "RAM"       : ['ERR_AGG_REGS', 'ESM_CPU1_REGS'],
    "Flash"     : ['ERR_AGG_REGS', 'ESM_CPU1_REGS', 'IPC_CPU1_SEND_REGS_HSM_CH0', 'IPC_CPU1_SEND_REGS_HSM_CH1', 'HSM_MAILBOX'],
    "SPI"       : ['ERR_AGG_REGS', 'ESM_CPU1_REGS', 'IPC_CPU1_SEND_REGS_HSM_CH0', 'IPC_CPU1_SEND_REGS_HSM_CH1', 'HSM_MAILBOX', 'PER_CFG_REGS_WD_REGS', 'GPIO_DATA_REGS', 'SPIA_REGS'],
    "I2C"       : ['ERR_AGG_REGS', 'ESM_CPU1_REGS', 'IPC_CPU1_SEND_REGS_HSM_CH0', 'IPC_CPU1_SEND_REGS_HSM_CH1', 'HSM_MAILBOX', 'PER_CFG_REGS_WD_REGS', 'GPIO_DATA_REGS', 'I2CA_REGS'],
...
const link1BootPeripherals = {
    "03" : bootPeriphMap["Flash"],
    "05" : bootPeriphMap["RAM"],
    "25" : bootPeriphMap["RAM"],
    "00" : bootPeriphMap["Parallel"],
    "20" : bootPeriphMap["Parallel"],
    "02" : bootPeriphMap["MCAN"],
    "22" : bootPeriphMap["MCAN"],
    "42" : bootPeriphMap["MCAN"],
    "62" : bootPeriphMap["MCAN"],
    "08" : bootPeriphMap["MCAN"],
    "48" : bootPeriphMap["MCAN"],
    "28" : bootPeriphMap["MCAN"],
    "68" : bootPeriphMap["MCAN"],
    "07" : bootPeriphMap["I2C"],
    "27" : bootPeriphMap["I2C"],
    "47" : bootPeriphMap["I2C"],
    "67" : bootPeriphMap["I2C"],
    "06" : bootPeriphMap["SPI"],
    "26" : bootPeriphMap["SPI"],
    "46" : bootPeriphMap["SPI"],
    "66" : bootPeriphMap["SPI"],
    "01" : bootPeriphMap["UART"],
    "21" : bootPeriphMap["UART"],
