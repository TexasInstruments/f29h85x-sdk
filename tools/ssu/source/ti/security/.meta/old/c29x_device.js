"use strict";
let {flash_code_sets, flash_data_sets}   = system.getScript('/ti/security/c29x_flash_data.js');
//let Common   = system.getScript('/ti/security/Common.js');

const total_aprs     = 64
const total_ext_aprs = 2
const total_links    = 16
const total_stacks   = 8
const total_zones    = 4
...
// let ram_memories = [
//     { name:'SRAM_LDAx',     type:'sram',   start:0x200E0000, size:0x20000 }, // CPU1/2 Data RAM
//     { name:'SRAM_LPAx',     type:'sram',   start:0x20100000, size:0x10000 }, // CPU1/2 Program RAM
//     { name:'SRAM_CPAx',     type:'sram',   start:0x20110000, size:0x10000 }, // CPU1/3 Shared Program RAM
//     { name:'SRAM_CDAx',     type:'sram',   start:0x20120000, size:0x30000 }, // CPU1/3 Shared Data RAM
// ];

// let flash_memories = [
//     { name:'FLASH_RP0',     type:'flash',   start:0x10000000, size:0x100000 },
//     { name:'FLASH_RP1',     type:'flash',   start:0x10100000, size:0x100000 },
//     { name:'FLASH_RP2',     type:'flash',   start:0x10200000, size:0x100000 },
//     { name:'FLASH_RP3',     type:'flash',   start:0x10300000, size:0x100000 },
// ]
...
[
    ...
    "CDA11.0", "CDA12.1", "CDA12.2", "CDA12.3"
].forEach((x, i) => {
...
let flash_memories = [];
["RP0", "RP1", "RP2", "RP3"].forEach((rp, j) =>{
    for(var i =0; i< 256; i++) //256=no of sectors, 1 sector = 4kB
    {
        flash_memories.push({name      : rp + "_SECT_" + i.toString(),
                             type      : 'flash',
...
let ext_memories = [
    { name:'EMIF1_CS0_NOBURST',     type:'extmem',   start:0x80000000, size:0x10000000 },
    { name:'EMIF1_CS1_NOBURST',     type:'extmem',   start:0x90000000, size:0x04000000 },
    { name:'EMIF1_CS2_NOBURST',     type:'extmem',   start:0x94000000, size:0x04000000 },
    { name:'EMIF1_CS3_NOBURST',     type:'extmem',   start:0x98000000, size:0x04000000 },

    { name:'EMIF1_CS0_BURST',     type:'extmem',   start:0xA0000000, size:0x10000000 },
    { name:'EMIF1_CS1_BURST',     type:'extmem',   start:0xB0000000, size:0x04000000 },
    { name:'EMIF1_CS2_BURST',     type:'extmem',   start:0xB4000000, size:0x04000000 },
    { name:'EMIF1_CS3_BURST',     type:'extmem',   start:0xB8000000, size:0x04000000 },
];
...
const crc32Table = [                                                                             // CRC32 lookup table for 0xEDB88320
