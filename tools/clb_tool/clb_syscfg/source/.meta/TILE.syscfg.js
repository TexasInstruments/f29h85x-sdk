...
function moduleInstances(inst)
{
    let components  = [
        {
            moduleName: "/clb_syscfg/source/BOUNDARY",
        ...
        {
            moduleName: "/clb_syscfg/source/LUT",
        ...
        {
            moduleName: "/clb_syscfg/source/FSM",
        ...
        {
            moduleName: "/clb_syscfg/source/COUNTER",
        ...
        {
            moduleName: "/clb_syscfg/source/OUTLUT",
        ...
        {
            moduleName: "/clb_syscfg/source/HLC",
    ...
    if (Common.isType1_Type2())
    {
        components = components.concat([
            {
                moduleName: "/clb_syscfg/source/AOC",
...
exports = {
    ...
    documentation       : "/clb_syscfg/source/CLB Tool Users Guide (beta1).pdf",
    moduleStatic        : {
        config : [
                    {
        ...
        if (inst && (system.getOS().includes("win"))) {
            return [
                {
                    ...
                    moduleName: "/clb_syscfg/source/clb_run_dynamic_template_clb_h.js"
                },
                {
                    name: "pullInTemplateC",
                    moduleName: "/clb_syscfg/source/clb_run_dynamic_template_clb_c.js"
                },
                {
                    name: "pullInTemplateSIM",
                    moduleName: "/clb_syscfg/source/clb_run_dynamic_template_clb_sim.js"
                },
                {
                    name: "pullInTemplateDOT",
                    moduleName: "/clb_syscfg/source/clb_run_dynamic_template_clb_dot.js"
                },
                {
                    name: "pullInTemplateBAT",
                    moduleName: "/clb_syscfg/source/clb_run_dynamic_template_simulation_bat.js"
                },
            ];
        }
        else if (inst) {
            return [
                ...
                },
                {
                    ...
                    moduleName: "/clb_syscfg/source/clb_run_dynamic_template_simulation_sh.js"
                },
            ];
        }
        return [];
